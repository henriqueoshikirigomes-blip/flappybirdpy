...
class Passaro:
    ...
    def desenhar(self, tela):
         ...
         pos_centro_imagem = self.imagem.get.rect(topleft=(self.x, self.y))
...
def desenhar_tela(tela, passaros, canos, chao, pontos):
       ...
       texto = FONTE_PONTOS.render(f'Potuacao: {pontos}', 1,(255,255,255))
                     ...
                     for cano in canos:
                           for i, passaro in enumerate(passaros):
                                 if cano.colidir(passaro):
                                       passaros.pop(1)
                                       if not cano.passouu and passaro.x >cano.x:
                                             cano.passouu = True
                                             adicionar_cano = True
                                             cano.mover()
